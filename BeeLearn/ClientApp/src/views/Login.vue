...
<template>
  <div class="max-w-sm mx-auto mt-24 px-4">
    <h1 class="text-2xl font-bold text-amber-600 mb-1">🐝 BeeLearn</h1>
    <p class="text-slate-500 mb-6 text-sm">Sign in to your account</p>
    ...
    <p class="text-sm text-slate-500 mt-4">
      No account? <RouterLink to="/register" class="text-amber-600">Register</RouterLink>
    </p>
  </div>
</template>
